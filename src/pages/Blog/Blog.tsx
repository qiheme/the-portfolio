			...
			<div className="row">
				<div className="col-md-4">
					<div className="fh5co-blog animate-box">
						<a href="#" className="blog-bg" style={{backgroundImage: "url(images/blog-1.jpg)"}}></a>
				...
				<div className="col-md-4">
					<div className="fh5co-blog animate-box">
						<a href="#" className="blog-bg" style={{backgroundImage: "url(images/blog-2.jpg)"}}></a>
						<div className="blog-text">
							<span className="posted_on">Feb. 15th 2016</span>
				...
				<div className="col-md-4">
					<div className="fh5co-blog animate-box">
						<a href="#" className="blog-bg" style={{backgroundImage: "url(images/blog-3.jpg)"}}></a>
						<div className="blog-text">
							<span className="posted_on">Feb. 15th 2016</span>
